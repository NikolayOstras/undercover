...
(() => {
  ...
  __name(showErrorMessage, "showErrorMessage");
  function hideErrorMessage(input) {
    const errorContainer = input.nextElementSibling;
    errorContainer.textContent = "";
    errorContainer.style.display = "none";
  }
  __name(hideErrorMessage, "hideErrorMessage");
  function isValidEmail(email) {
    const emailRegex = /^\S+@\S+\.\S+$/;
    return emailRegex.test(email);
  }
  __name(isValidEmail, "isValidEmail");
  var formValidation = /* @__PURE__ */ __name((formSelector) => {
    const form2 = document.querySelector(formSelector);
    if (!form2)
      return;
    const nameInput = form2.querySelector('input[type="text"]');
    const emailInput = form2.querySelector('input[type="email"]');
    const messageInput = form2.querySelector("textarea");
  ...
  function Navigation(_ref) {
    ...
    const makeElementsArray = /* @__PURE__ */ __name((el) => (Array.isArray(el) ? el : [el]).filter((e) => !!e), "makeElementsArray");
    function getEl(el) {
      let res;
  ...
  var servicesBtnsHandler = /* @__PURE__ */ __name(() => {
    const btns = document.querySelectorAll(".service-item");
    if (btns.length) {
      const setActiveClass = /* @__PURE__ */ __name((btn) => {
        btns.forEach((el) => {
  ...
  var dropdownHandler = /* @__PURE__ */ __name(() => {
    const dropdownButton = document.querySelector(".dropdown__button");
    const dropdownList = document.querySelector(".dropdown__list");
    const dropdownItems = document.querySelectorAll(".dropdown__item");
    if (!dropdownButton || !dropdownList || !dropdownItems)
      return;
    ...
    document.addEventListener("keydown", (event2) => {
      if (event2.key === "Escape" && dropdownList.style.display !== "none") {
        closeDropdown();
      }
    });
  }, "dropdownHandler");
  ...
  documentHeight();
  var headerHeight = /* @__PURE__ */ __name(() => {
  ...
  var openOverlay = /* @__PURE__ */ __name((target) => {
  ...
  var closeOverlay2 = /* @__PURE__ */ __name(() => {
  ...
  var handleEscapeKey = /* @__PURE__ */ __name((event2) => {
  ...
  if (menuBtn) {
    menuBtn.addEventListener("click", () => {
      ...
      menuIsOpen || formIsOpen ? closeOverlay2() : openOverlay("menu");
    });
  }
